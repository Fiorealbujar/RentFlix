// ==========================================
// CLASE: CopiaDAO.java — ACTUALIZADA
// ==========================================
package dao;
...
public class CopiaDAO implements ICopiaDAO {
    ...
    @Override
    public List<Copia> listarTodasDisponibles() {
        List<Copia> lista = new ArrayList<>();
        String sql = "SELECT * FROM Copias WHERE estado = 'disponible' " +
                     "ORDER BY id_pelicula, formato";
        try (Statement st = con.createStatement();
             ResultSet rs = st.executeQuery(sql)) {
            while (rs.next()) lista.add(mapear(rs));
        } catch (SQLException e) {
            System.err.println("CopiaDAO.listarTodasDisponibles: " +
                               e.getMessage());
        }
        return lista;
    }
    ...
    public List<Copia> listarDisponiblesPorPelicula(int idPelicula) {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            System.err.println("CopiaDAO.listarDisponiblesPorPelicula: " +
                               e.getMessage());
        }
        return lista;
    }
    ...
    @Override
    public List<Copia> listarDisponiblesPorFormato(String formato) {
        List<Copia> lista = new ArrayList<>();
        String sql = "SELECT * FROM Copias " +
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            System.err.println("CopiaDAO.listarDisponiblesPorFormato: " +
                               e.getMessage());
        }
        return lista;
    }
    ...
    public boolean actualizarEstado(int idCopia, String nuevoEstado) {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            System.err.println("CopiaDAO.actualizarEstado: " +
                               e.getMessage());
            return false;
        }
    }
