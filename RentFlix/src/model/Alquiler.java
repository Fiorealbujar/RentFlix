...
public class Alquiler {
    ...
    public Alquiler(int idAlquiler, int idCliente, int idCopia,
                    Integer idEmpleado, Integer idTransaccion,
                    String fechaAlquiler, String fechaDevolucionPrevista,
                    String fechaDevolucionReal, String estadoAlquiler) {
    ...
    public void setFechaDevolucionPrevista(String fechaDevolucionPrevista)   { this.fechaDevolucionPrevista = fechaDevolucionPrevista; }
